...
test.describe('US05 - Commande | Récapitulatif et finalisation', () => {
  test(
    ...
    async ({
      ...
      const subtotal = await checkoutPage.displayedAmount(
  ...
  test(
    'TC-US05-AC01-05 annulation depuis le récapitulatif retourne au catalogue',
    async ({
      authenticatedPage,
      inventoryPage,
      cartPage,
  ...
  test(
    'TC-US05-AC02-01 achat d’un produit @smoke @critical',
    async ({
      authenticatedPage,
      inventoryPage,
      cartPage,
